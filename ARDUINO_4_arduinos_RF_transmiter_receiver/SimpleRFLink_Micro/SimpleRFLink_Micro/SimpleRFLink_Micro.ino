...
void setup()
{
  ...
  vw_set_rx_pin(4);         //Pin 2 is connected to "Digital Output" of receiver
...
void loop()
{
 //////SENDING///////
  ...
  if(digitalRead(2) == LOW){
    digitalWrite(9, true);  //Flash status LED to show transmitting
    ...
    digitalWrite(9, false); //Turn off status LED
  }
